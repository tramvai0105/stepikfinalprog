...
class LoginPage(BasePage):
    ...
    def register_new_user(self, email, password):
        ...
        self.browser.find_element(*LoginPageLocators.REGISTER_INPUT_PASSWORD1).send_keys(password)
        self.browser.find_element(*LoginPageLocators.REGISTER_INPUT_PASSWORD2).send_keys(password)
